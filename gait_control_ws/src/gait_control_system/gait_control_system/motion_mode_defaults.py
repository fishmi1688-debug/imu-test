...
_BASE_MOTION_MODES: Dict[str, Dict[str, Any]] = {
    ...
    "walking_diff_test": {
        "name": "步行差分测试模式",
        "name_en": "Walking Diff Test",
        # 助力曲线沿用 walking_test；相位输入改为滤波后的左右电机编码器角度差。
        "ext_t0": 0.00,
        "ext_tf": 0.30,
        "ext_p": 0.70,
        "ext_Tmax": 5.0,
        ...
        "phase_bias_slope": 0.0,
        "event_prob_threshold": 0.8,
        "description": "步行差分测试模式（左-右电机编码器角度差峰值定时，手动启停）",
    },
    "cycling": {
        "name": "骑自行车",
        "name_en": "Cycling",
    ...
    "imu_phase": {
        ...
        # 助力曲线沿用 walking_test 默认参数，仅相位来源切换为左右 MI1 CAN 大腿IMU。
        "ext_t0": 0.00,
        "ext_tf": 0.30,
        "ext_p": 0.70,
        "ext_Tmax": 5.0,
        ...
        "description": "使用左右MI1有线CAN大腿IMU生成相位，助力曲线沿用步行测试参数，手动启停",
    },
    "imu_left_phase": {
        "name": "左有线IMU相位模式",
        "name_en": "Left Wired IMU Phase",
        # 助力曲线沿用 walking_test 默认参数，仅相位来源切换为左 MI1 CAN 大腿IMU。
        "ext_t0": 0.00,
        "ext_tf": 0.30,
        "ext_p": 0.70,
        "ext_Tmax": 5.0,
    ...
    "model_phase": {
        "name": "模型相位模式",
        "name_en": "Model Phase",
        # 助力曲线沿用 walking_test 默认参数，相位来源切换为双MI1 IMU + ONNX步态模型。
        "ext_t0": 0.00,
        "ext_tf": 0.30,
        "ext_p": 0.70,
        "ext_Tmax": 5.0,
        ...
        "phase_bias_slope": 0.0,
        "event_prob_threshold": 0.8,
        "description": "使用双MI1有线CAN IMU和ONNX步态模型估计相位，采用后处理相位计算助力，手动启停",
    },
    "imu_left_ao_phase": {
        "name": "左有线IMU自适应振荡相位模式",
        "name_en": "Left Wired IMU AO Phase",
        # 助力曲线沿用左有线IMU相位模式默认参数；相位改为左腿IMU自适应振荡器估计。
        "ext_t0": 0.00,
        "ext_tf": 0.30,
        "ext_p": 0.70,
        "ext_Tmax": 5.0,
        ...
        "event_prob_threshold": 0.8,
        "swing_threshold": DEFAULT_IMU_PHASE_SWING_THRESHOLD_DEG,
        "description": "使用左有线大腿IMU矢状面角度/角速度输入自适应振荡器估计左腿相位，右腿相位=左腿相位+pi，手动启停",
    },
    "imu_ao_phase": {
        "name": "有线IMU自适应振荡相位模式",
        "name_en": "Wired IMU AO Phase",
        # 助力曲线沿用有线IMU相位模式默认参数；左右相位分别由各自IMU自适应振荡器估计。
        "ext_t0": 0.00,
        "ext_tf": 0.30,
        "ext_p": 0.70,
        "ext_Tmax": 5.0,
        ...
        "event_prob_threshold": 0.8,
        "swing_threshold": DEFAULT_IMU_PHASE_SWING_THRESHOLD_DEG,
        "description": "使用左右有线大腿IMU矢状面角度/角速度分别输入自适应振荡器估计左右相位，手动启停",
    },
}
